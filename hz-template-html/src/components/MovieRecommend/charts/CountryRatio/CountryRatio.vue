<template>
  <div class="CountryRatio w100 h100 pd-20">
    <div class="w100 h100" id="CountryRatio"></div>
  </div>
</template>

<script>
// 引入api
import { getAdsDoubanCountry } from "@/api/MovieRecommend/bigScreen";
// 引入饼状图纹理
  ...
  methods: {
    draw() {
      let myChart = this.$echarts.init(
        document.getElementById("CountryRatio"),
        "transLight_5"
      );
      ...
      this.option = {
        ...
        series: [
          {
            name: "电影数量占比:", // tooltip 的标题将默认显示name的值
            type: "pie",
